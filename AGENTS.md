...
This project is indexed by GitNexus as **2FA-Vault** (6486 symbols, 13378 relationships, 185 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
